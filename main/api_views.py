		...
		try:
			try:
				...
				for item in file_names:
					aux = item.split("_")
					name = "{}-{}".format(aux[4], aux[5]) # important
					# print(item)
					df_change_filter = pd.read_csv("{}/output/{}/changes/{}".format(exp_path, serializer.data["id"], item), low_memory=False) # , dtype={"source": "string", "target": "string"})
					...
					# df_change_filter.fillna("Unknown", inplace=True)
				...
				df_edges_filter_weight_filter = pd.read_csv("{}/output/{}/common_edges/{}_{}_{}_{}.csv".format(exp_path,
																												exp,
																												f,
																												method,
																												group_id,
	...
	def post(self, request, format=None):
		try:
			try:
				...
				df_change_filter = pd.read_csv("{}/output/{}/changes/edges_log2_{}_{}_{}_{}.csv".format(exp_path,
																												experiment.pk,
																												f,
																												experiment.method,
																												group.replace("-", "_"),
				...
				for group_ in groups:
					df_biocyc = pd.read_csv("{}/output/{}/biocyc/{}_{}_{}_{}.csv".format(exp_path,
																								experiment.pk,
																								f,
																								experiment.method, 
																								group_, 
