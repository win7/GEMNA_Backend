...
for method in methods[:1]: # change
    for option in options[:1]: # change
            ...
            for groups in list_groups: # change
                ...
                df_biocyc.to_csv("output/{}/biocyc/biocyc_{}_{}_{}.csv".format(exp, method, "-".join(groups), option), index=False, sep="\t") # header=False
                
                df_biocyc = pd.read_csv("output/{}/biocyc/biocyc_{}_{}_{}.csv".format(exp, method, "-".join(groups), option),
